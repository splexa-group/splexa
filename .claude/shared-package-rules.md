...
This means consumers import cleanly:
...
`zod` is the only allowed dependency in `packages/shared`. If you need another dependency, ask: is this truly needed by both apps? If yes, does it have zero platform-specific APIs?
