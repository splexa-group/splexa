...
- Full spec: `docs/superpowers/specs/2026-08-01-frontend-feature-restructure-design.md` — read it once before starting; every task below implements a specific section of it.
